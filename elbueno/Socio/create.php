...
<?php if ($_POST) {
    ...
    $stm=$conexion->prepare("INSERT INTO socio (nombre,aPaterno,aMaterno,calle,colonia,cuidad,estado,telefono,pais)
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="text" class="form-control" name="aMaterno" value="" placeholder="ingresa el aprellido materno">
